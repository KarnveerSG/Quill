"""Lightweight mtime-based file watcher for live-reloading SexyJarvis config.

Watches the small set of files SexyJarvis loads at startup (SEXYJARVIS.md /
CLAUDE.md, .sexyjarvisignore, hooks.json, config.toml profile, custom command
...
_WATCH_FILES = [
    ...
    ".claude/CLAUDE.md",
    ".sexyjarvisignore",
    ".sexyjarvis/hooks.json",
    ".sexyjarvis/config.toml",
    ".sexyjarvis/tools.json",
]
_WATCH_DIRS = [
    ".sexyjarvis/commands",
]
